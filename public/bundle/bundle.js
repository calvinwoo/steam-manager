...
/***/ function(module, exports, __webpack_require__) {
	...
	React.render(
	  React.createElement(Library, {userName: userName}),
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  render: function() {
	    return (
	      React.createElement("div", null, 
	        React.createElement(Welcome, {userName: this.props.userName}), 
	        React.createElement(SearchBox, {onChange: this.searchGames}), 

	        React.createElement(SearchResults, {sortedGames: this.state.sortedGames})
	      )
	    );
	  }
	});
	...
	var Welcome = React.createClass({displayName: "Welcome",
	  render: function() {
	    return (
	      React.createElement("h2", null, "Hello ", this.props.userName, "!")
	    )
	  }
	});
	    ...
	    return (
	      React.createElement("ul", null, 
	          ...
	          this.props.sortedGames.map(function(game) {
	            return React.createElement("li", {key: game.id}, game.name)
	          })
